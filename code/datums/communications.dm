...
/datum/communciations_controller/proc/send_roundstart_report(greenshift)
	...
	. = "<b><i>Nanotrasen Department of Intelligence Threat Advisory, Eidolon Sector, TCD [time2text(world.timeofday, "DDD, MMM DD")], [CURRENT_STATION_YEAR]:</i></b><hr>" // OCULIS EDIT
	. += dynamic_report
